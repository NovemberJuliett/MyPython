...
print(str("78 - ") + (translit(num2words(78, lang='en'), "ru")))
print(str("15 - ") + (translit(num2words(15, lang='en'), "ru")))
print(str("3 - ") + (translit(num2words(3, lang='en'), "ru")))
print(str("40 - ") + (translit(num2words(40, lang='en'), "ru")))
print(str("8 - ") + (translit(num2words(8, lang='en'), "ru")))
